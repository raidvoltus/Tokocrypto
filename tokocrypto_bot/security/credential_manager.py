...
class SecureCredentialStore:
    ...
    def save_credentials(
        ...
        """Enskripsi dan simpan rahasia ke file terproteksi DPAPI (Windows Only)."""
        ...
        try:
            ...
            logger.info("All credentials encrypted and stored successfully via Windows DPAPI.")
            return True
    ...
    def load_credentials(self) -> DecryptedCredentials:
        """Men-dekripsi rahasia secara aman langsung di memori saat runtime."""
