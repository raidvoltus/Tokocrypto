...
DESCRIPTION: Schema version control and migration runner for NVRA Trading Engine.
"""
...
MIGRATIONS = [
    {
        "version": 1,
        "description": "Initial state schema with durable order event tracking",
        "queries": [
            """
...
def run_migrations(db_manager: DatabaseManager) -> None:
    """Mengeksekusi seluruh migrasi yang belum terpasang secara transaksional."""
